...
* [Синтаксис и семантика](syntax_and_semantics/README.md)
   ...
   * [Типы и методы](syntax_and_semantics/types_and_methods.md)
       ...
       * [Классы и методы](syntax_and_semantics/classes_and_methods.md)
           ...
           * [Вывод типов](syntax_and_semantics/type_inference.md)
           * [Перегрузка](syntax_and_semantics/overloading.md)
           * [Именованные аргументы и значения по умолчанию](syntax_and_semantics/default_and_named_arguments.md)
           * [Астериски и кортежи](syntax_and_semantics/splats_and_tuples.md)
           * [Ограничения по типу](syntax_and_semantics/type_restrictions.md)
           * [Возвращаемые типы](syntax_and_semantics/return_types.md)
           * [Аргументы метода](syntax_and_semantics/default_values_named_arguments_splats_tuples_and_overloading.md)
       ...
       * [Псевдонимы](syntax_and_semantics/alias.md)
